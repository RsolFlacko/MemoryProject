...
public class InicioJuego extends javax.swing.JFrame {
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try {
            ...
            outRequest.writeUTF(players);
            
            String tamañoString = inResponse.readUTF();
            
            ArrayList<String> data = new ArrayList<String>(Arrays.asList(tamañoString.split(",")));
            
            i = Integer. parseInt(data.get(0));
            j = Integer. parseInt(data.get(1));
            turno = Integer. parseInt(data.get(2));
